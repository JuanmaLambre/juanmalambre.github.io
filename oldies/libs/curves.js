/* abstract */ class Curve {
  ...
  draw(segments) {
    if (this.fillArgs == null) noFill();
    else if (this.fillArgs != undefined) fill(...this.fillArgs);

    if (this.strokeArgs == null) noStroke();
    else if (this.strokeArgs != undefined) stroke(...this.strokeArgs);

    if (this.strokeWeightArgs != undefined) strokeWeight(...this.strokeWeightArgs);
      ...
      switch (command) {
        ...
        case "C":
          ...
          while (dataIdx < data.length && !data[dataIdx].match(/[a-zA-Z]/)) {
            ...
            if (pointsCount == 4) {
              const bezier = new Bezier2(points[0], points[1], points[2], points[3]);
